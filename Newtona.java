...
public class Main {
    ...
    double [] mnoz(double [][] m1, double [] m2)
    {
        double [] wynik = new double[2];
    ...
    void Licz()
    {
        ...
        double [] xk1;
        xk1= odejmij(xk,mnoz(MacierdzOdw(liczHessego(xk[0],xk[1])),liczGradient(xk[0],xk[1])));
        ax.add(xk1[0]);
        ay.add(xk1[1]);
        ...
        System.out.println("x="+ax.get(ax.size()-1));
        System.out.println();
        System.out.println("y="+ay.get(ay.size()-1));
    }

    public static void main(String[] args) {
        Main app = new Main();
//        app.Licz();
        System.out.println(app.liczGradient(2,2)[1]);
    }
}
